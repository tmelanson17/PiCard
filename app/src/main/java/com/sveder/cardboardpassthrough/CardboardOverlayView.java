...
public class CardboardOverlayView extends LinearLayout {
            ...
            case 0:
                ...
                mLeftView.videoView.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
                    public void onPrepared(MediaPlayer mediaPlayer) {
                        mRightView.videoView.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
                            public void onPrepared(MediaPlayer mediaPlayer) {
    ...
    private class CardboardOverlayEyeView extends ViewGroup
    {
        ...
        protected void onLayout(boolean changed, int left, int top, int right, int bottom)
        {
            ...
            final float verticalImageOffset = -0.1f;
            ...
            videoView.layout(
                    (int) (leftMargin2 * 1.4), (int) (topMargin2 * 1.0),
                    (int) (leftMargin2 + width * imageSize * 1.75), (int) (topMargin2 + height * imageSize * 1.2));
        }
    }
}